...
exports.BrowserFileHandler = exports.LogLevel = exports.ModuleLogger = void 0;
exports.getModuleLogger = getModuleLogger;
exports.configureModuleLogger = configureModuleLogger;
// Niveles de log
var LogLevel;
(function (LogLevel) {
...
class BrowserFileHandler {
    constructor() {
        this.logs = [];
        this.maxEntries = 1000; // Límite de entradas en memoria
    }
    write(message) {
...
exports.BrowserFileHandler = BrowserFileHandler;
class ModuleLogger {
    constructor(moduleName) {
        this.consoleHandler = true;
    ...
    formatMessage(level, message, file, line) {
...
function configureModuleLogger(_logger, moduleName) {
