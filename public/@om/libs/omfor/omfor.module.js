...
let OmForModule = class OmForModule {
    constructor() {
        // Inicialización del módulo
        console.log('CoreModule initialized');
    }
};
exports.OmForModule = OmForModule;
exports.OmForModule = OmForModule = __decorate([
    (0, module_decorator_1.Module)({
        providers: [om_utils_1.OmUtils, omfor_provider_1.OmForProviders],
    }),
