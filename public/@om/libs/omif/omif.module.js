...
let OmIfModule = class OmIfModule {
    constructor() {
        // Inicialización del módulo
        console.log('CoreModule initialized');
    }
};
exports.OmIfModule = OmIfModule;
exports.OmIfModule = OmIfModule = __decorate([
    (0, module_decorator_1.Module)({
        providers: [om_utils_1.OmUtils, omif_provider_1.OmIfProviders],
    }),
